...
def test_config_files_exist(proxy_bin_dir, file_path):
    ...
    if not check_file_exists(full_path):
        pytest.fail(
            ...
            "Please verify that your Makefile correctly places the files into the 'install/' directory or subdirectories.\n"
        )
